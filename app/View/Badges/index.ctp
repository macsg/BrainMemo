<div class="badges index">
	...
	<tr>
		...
		<td><?php echo h($badge['Badge']['thumbnail']); ?>&nbsp;</td>
		<td><?php echo h($badge['Badge']['detail']); ?>&nbsp;</td>
		<td><?php echo h($badge['Badge']['created']); ?>&nbsp;</td>
		<td><?php echo h($badge['Badge']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $badge['Badge']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $badge['Badge']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
