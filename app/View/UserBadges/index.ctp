<div class="userBadges index">
	<h2><?php echo __('User Badges'); ?></h2>
	...
	<tr>
		<td><?php echo h($userBadge['UserBadge']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($userBadge['UserBadge']['created']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $userBadge['UserBadge']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $userBadge['UserBadge']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userBadge['UserBadge']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $userBadge['UserBadge']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
